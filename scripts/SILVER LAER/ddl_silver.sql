/*
DDL SCRIPT: CREATED SLIVER TABLES
SCRIPT PURPOSE: THIS SCRIPT CREATE A TABLES IN BRONZE LAYER. RUN THIS SCRIPT TO REDEFIENE THE DDL SCTRUCRE OF SILVER TABLES
*/
